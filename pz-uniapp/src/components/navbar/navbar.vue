<template>
  <view class="nav">
    ...
    <view v-if="isHome" class="headNav" :style="'height:' + navHeight + 'rpx;line-height:' + navHeight + 'rpx;padding-left:20rpx;'">
      ...
      <view style="flex: 1">
        <navigator 
          ...
          :style="'height:'+ menu.height*2 + 
            'rpx;line-height:'+ menu.height*2 + 
            'rpx;margin-top:'+(menu.top*2 - status) +
            'rpx;margin-left:32rpx;margin-right:' + (menu.width*2 + 24) +
    ...
    <!-- 非首页 -->
    <view v-else class="navbar" :style="{height:navHeight + 'rpx', lineHeight:navHeight + 'rpx', paddingLeft:'20rpx', containerStyle}">
